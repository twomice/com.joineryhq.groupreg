...
CREATE TABLE `civicrm_groupreg_event` (
  ...
  `is_require_existing_contact` tinyint NOT NULL DEFAULT 0,
  ...
  CONSTRAINT FK_civicrm_groupreg_event_related_contact_tag_id FOREIGN KEY (`related_contact_tag_id`) REFERENCES `civicrm_tag`(`id`) ON DELETE SET NULL
)
ENGINE=InnoDB;
