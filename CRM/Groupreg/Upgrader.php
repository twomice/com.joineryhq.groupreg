 ...
 */
class CRM_Groupreg_Upgrader extends CRM_Extension_Upgrader_Base {
  ...
  public function upgrade_4200() {
    ...
    CRM_Core_DAO::executeQuery("ALTER TABLE `civicrm_groupreg_event` CHANGE `is_prompt_related` `is_prompt_related` int unsigned NOT NULL  DEFAULT 0");
