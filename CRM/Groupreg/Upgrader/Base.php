 ...
 */
class CRM_Groupreg_Upgrader_Base {

  /**
   * @var CRM_Groupreg_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Groupreg_Upgrader(
        'com.joineryhq.groupreg',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * ```
   * CRM_Groupreg_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Groupreg_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
